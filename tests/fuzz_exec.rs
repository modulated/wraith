...
mod coverage {
    ...
    const REASONS: &[(&str, &str)] = &[
        ...
        (
            "Stmt::Return",
            "the called form returns nothing; a value-returning call would need the oracle to \
             model the return convention",
        ),
        (
            "Stmt::ForEach",
    ...
    const CAVEATS: &[(&str, &str)] = &[
        ...
        (
            "Expr::Call",
            "one call, no arguments, no return value, no recursion",
        ),
        (
            "Expr::Cast",
